...
import { DiscussionsForum } from "../components/DiscussionsForum.tsx"
import { SensitiveDataPage } from "../components/SensitiveDataPage.tsx"
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "profile":
        return <UserProfile/>
        case "discussion":
          return <DiscussionsForum/>
          case "sensitivedata":
            return <SensitiveDataPage/>
      case "admin":
